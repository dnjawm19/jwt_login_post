package com.example.jwt_login_post.jwt.util;
...
import com.example.jwt_login_post.security.user.UserDetailsServiceImpl;
...
public class JwtUtil {
    ...
    private static final long ACCESS_TIME = 50 * 1000L;
    private static final long REFRESH_TIME = 1000 * 1000L;
